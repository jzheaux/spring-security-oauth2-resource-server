...
public class Auth0JwtAccessTokenConverterTests {
	@Test
	public void whenSignatureAndIssuerValid_thenDecodeToken() throws IOException {
		...
		Map<String, Object> claims = defaultVerifier().decode(goodToken);

		assertThat(claims.get("iss")).isEqualTo("rob");
	}
	...
	protected Auth0JwtAccessTokenConverter defaultVerifier() throws IOException {
